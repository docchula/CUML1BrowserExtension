...
if (tabInfo.url.indexOf("cuml1.md.chula.ac.th") !== -1) {
    ...
    convertButton.addEventListener('click', async () => {
        ...
        if (newURL.split('/')[2] === "login") newURL = "https://www.google.com/"; // special case for CUML1 homepage // should be newtab but error
    ...
    convertButton.addEventListener('click', async () => {
        ...
        if (newURL.split(':')[0] === "about") newURL = "https://cuml1.md.chula.ac.th/"; // special case for firefox tabs
